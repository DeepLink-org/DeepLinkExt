...
// void extTokenDecodeAttentionInference(const at::Tensor& q, const at::Tensor&
// k,
//                                       const at::Tensor& v, at::Tensor& out,
//                                       const at::Tensor& b_loc,
//                                       const at::Tensor& b_start_loc,
...
//                                       int max_input_len, int other_kv_index)
//                                       {
//   callDiopi(diopiTokenDecodeAttentionInference, out, q, k, v, b_loc,
//   b_start_loc,
//             b_seq_len, max_input_len, other_kv_index);
// }

// void extTokenDecodeAttentionInferenceBatchOne(const at::Tensor& q, const
// at::Tensor& k,
//                                       const at::Tensor& v, at::Tensor& out,
//                                       const at::Tensor& b_loc,
//                                       const at::Tensor& b_start_loc,
...
//                                       int max_input_len, int other_kv_index)
//                                       {
//   callDiopi(diopiTokenDecodeAttentionInferenceBatchOne, out, q, k, v, b_loc,
//   b_start_loc,
//             b_seq_len, max_input_len, other_kv_index);
// }
...
//                             {}, int64_t num_heads = 1, double scale_value
//                             = 1.0, const std::string& input_layout = "BSH",
//                             int64_t num_key_value_heads = 0) {
//   callDiopi(diopiIncreFlashAttention, out, q, k, v, padding_mask, atten_mask,
//             actual_seq_lengths, num_heads, scale_value, input_layout.c_str(),
//             num_key_value_heads);
// }
...
void extPagedAttention(at::Tensor& out, const at::Tensor& q,
                       ...
                       const at::Tensor& block_table, int64_t block_size) {
  callDiopi(diopiPagedAttention, out, q, k, v, actual_seq_lengths, numHeads,
            numKeyValueHeads, dim, block_table, block_size);
}
...
void extMatmulAllReduceAddRmsNorm(at::Tensor& out, at::Tensor& out_bf_norm,
                                  ...
                                  const char* group, const char* reduce_op,
                                  int64_t comm_turn, int64_t stream_mode) {
  callDiopi(diopiMatmulAllReduceAddRmsNorm, out, out_bf_norm, x1, x2, residual,
            bias, gamma, eps, group, reduce_op, comm_turn, stream_mode);
}
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  //   m.def("token_decode_attention_inference",
  //   &extTokenDecodeAttentionInference,
  //         "deeplink token_decode_attention_inference");
  // }
  // if (&diopiTokenDecodeAttentionInferenceBatchOne != nullptr) {
  //   m.def("token_decode_attention_inference_batch_one",
  //   &extTokenDecodeAttentionInferenceBatchOne,
  //         "deeplink token_decode_attention_inference");
  // }
  ...
  if (&diopiMatmulAllReduceAddRmsNorm != nullptr) {
    m.def("matmul_all_reduce_add_rms_norm", &extMatmulAllReduceAddRmsNorm,
          "deeplink ext_matmul_all_reduce_add_rms_norm", py::arg("out"),
          py::arg("out_bf_norm"), py::arg("x1"), py::arg("x2"),
          py::arg("residual"), py::arg("bias"), py::arg("gamma"),
          py::arg("eps"), py::arg("group"), py::arg("reduce_op") = "sum",
