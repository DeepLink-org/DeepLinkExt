import sys
import torch
from lmdeploy.pytorch.engine.devices.base_device_utils import BaseDeviceUtils
    ...
    def update_step_context(cls, step_context):
        ...
        for i in range(step_context.q_start_loc.size(0)):
            ...
            for _ in range(step_context.q_seq_length[i]):
                ...
                block_loc = step_context.block_offsets[i][block_idx]
        step_context.kv_start_indices = torch.tensor(kv_start_indices, device=step_context.block_offsets.device)
