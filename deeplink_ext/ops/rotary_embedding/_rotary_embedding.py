...
if platform_type == PlatformType.TORCH_DIPU || platform_type == PlatformType.TORCH_CUDA:
    from ._rotary_embedding_dipu import ApplyRotaryEmb, ApplyRotaryEmbQKV_, apply_rotary
else:
    raise ImportError
