...
class TestFlashSelfAttention:
    ...
    def test_self_attention_varlen_q_kv_mha(self):
        ...
        cu_seqlens_q_ref = torch.tensor(g_cu_seqlens, dtype=torch.int32, device="npu")
        cu_seqlens_k_ref = torch.tensor(g_cu_seqlens, dtype=torch.int32, device="npu")
        max_seqlen = 1919
    ...
    def test_self_attention_varlen_q_kv_gqa_long_max_seqlen(self):
        ...
        cu_seqlens_q_ref = torch.tensor(cu_seqlens_max_length_4096, dtype=torch.int32, device="npu")
        cu_seqlens_k_ref = torch.tensor(cu_seqlens_max_length_4096, dtype=torch.int32, device="npu")
...
class TestFlashCrossAttention:
    ...
    def test_cross_attention_varlen_q_kv_mha(self):
        ...
        cu_seqlens_ref = torch.tensor(g_cu_seqlens, dtype=torch.int32, device="npu")
        cu_seqlens_k_ref = torch.tensor(g_cu_seqlens, dtype=torch.int32, device="npu")
        max_seqlen = 1919
    ...
    def test_cross_attention_varlen_q_kv_gqa(self):
        ...
        cu_seqlens_ref = torch.tensor([0, 32, 64, 128, 256], dtype=torch.int32, device="npu")
        cu_seqlens_k_ref = torch.tensor([0, 32, 64, 128, 256], dtype=torch.int32, device="npu")
        max_seqlen = 128
    ...
    def test_cross_attention_varlen_q_kv_gqa_long_max_seqlen(self):
        ...
        cu_seqlens_ref = torch.tensor([0, 32, 64, 128, 4224], dtype=torch.int32, device="npu")
        cu_seqlens_k_ref = torch.tensor([0, 32, 64, 128, 4224], dtype=torch.int32, device="npu")
        # the maximum sequence length is 4096
        max_seqlen = 4096
